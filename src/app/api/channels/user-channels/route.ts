...
export async function GET(req: Request) {
  ...
  const response = await axios.get(`https://api.neynar.com/v2/farcaster/channel/user?fid=${targetFid}&cursor=${cursor}&limit=10`, { "headers": { "api_key": process.env.NEYNAR_API_KEY } })
