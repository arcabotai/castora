...
export default function SuperChannelTrendingPosts() {
  ...
  const fetchChannelPreviewData = async () => {
    ...
    const response = await axios.get(`${HOST_URL}/api/channels/super/preview`, {
      headers: {
      ...
      <Carousel setApi={setChannelTrendingCarouselAPI}>
        <div className="flex flex-col gap-y-2">
          <div className="flex flex-row items-center justify-between">
            <h2 className="text-lg font-medium tracking-tight">Trending on <Link href="/channel/super" className="font-semibold">/super</Link></h2>
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400">
            Trending posts from our community
          </p>
          <CarouselContent>
